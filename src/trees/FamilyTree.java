...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
        ...
        TreeNode getNodeWithName(String targetName)
        {
            ...
            for (TreeNode child: this.children)
            {
            	...
            	TreeNode returnThis = child.getNodeWithName(targetName);
            	if (returnThis != null) {
                    return returnThis;
                }
            }
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0) {
			throw new TreeException("This is not a correctly written line.");
		}
		...
		else
		{
			...
			if(parentNode == null) {
				throw new TreeException("Such parent does not exist.");
			}
		}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null) {
			throw new TreeException("Such person does not exist.");
		}
